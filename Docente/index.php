...
<body class="BKG">
    ...
    <form action="login.php" method="POST"
        ...
        <div style="display:flex; justify-content:center; margin-bottom:0.25rem; margin-top:0.5rem;">
            <img src="<?php echo $ruta; ?>img/Logo-Santa.jpeg" 
                alt="Logo Santa Teresita" 
        ...
        <p class="text-2xl font-medium text-center">
            ...
            <h6 align="center">Santa Teresita - Docente</h6>
        </p>

        <div class="mt-4">
            <label class="block"><i class="bi bi-envelope"></i> Correo</label>
        ...
        <p class="mt-4">
            ...
            <a href="../recuperar_clave.php?origen=docente" class="text-indigo-500">Haga clic aquí</a>
        </p>
